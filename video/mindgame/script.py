...
LINES = [
    ...
    ("m4", "Long-term goals. Becoming a doctor takes ten years. The length of tasks A.I. agents can finish doubles every four to seven months, but it's still hours, not years.",
     "Long-term goals. Becoming a doctor takes ten years. The length of tasks AI agents can finish doubles every 4–7 months, but it’s still hours, not years.", 0.15, {}),
