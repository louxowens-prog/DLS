...
| Claude steps through "Texas" to reach "Austin" | Anthropic, "Tracing the thoughts of a large language model" (27 Mar 2025), Claude 3.5 Haiku | Added. It is direct evidence for the brief's "next-token prediction ≠ simple". |
