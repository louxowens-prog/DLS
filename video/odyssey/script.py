...
LINES = [
    ...
    ("rock", "Ask it how to lift a rock with three planks, a rope and a broken pulley.", None, 0.16),
    ...
    ("nist", "The U.S. standards agency, NIST, counts machines doing tasks that need human-like perception, planning, learning or communication.", None, 0.16),
