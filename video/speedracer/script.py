...
LINES = [
    ...
    ("u2", "Perceive. Model the world. Predict. Plan. Act. Observe. Learn. And again.", None, 0.1, {"speed": 1.15}),
    ...
    ("w1", "One last twist. Every time machines win a lap, calculation, chess, language, vision, we move the finish line. That's just computation.",
     "One last twist. Every time machines win a lap (calculation, chess, language, vision) we move the finish line. “That’s just computation.”", 0.1, {}),
